...
pd.DataFrame(df.sum(), columns=['sum']).to_csv("tasks/result_1.csv")
os.system('sshpass -p "tafraliang" scp -vr tasks/result_1.csv kalikho@172.16.117.17:/home/kalikho/icbc/outputs/')
...
while(1):
    if(os.path.isfile("tasks/result_2_verification.csv")):
        ...
        pd.DataFrame(df.sum(), columns=['sum']).to_csv("tasks/result_1_2.csv")
        os.system('sshpass -p "tafraliang" scp -vr tasks/result_1_2.csv kalikho@172.16.117.17:/home/kalikho/icbc/verification_output/')
        print("===")
        print(datetime.datetime.now())
        ...
        print("===")
        df = pd.read_csv('tasks/result_2_verification.csv', index_col=False,delim_whitespace=True)
        pd.DataFrame(df.sum(), columns=['sum']).to_csv("tasks/result_1_3.csv")
        ...
        pd.DataFrame(df.sum(), columns=['sum']).to_csv("tasks/result_1_4.csv")
        os.system('sshpass -p "tafraliang" scp -vr tasks/result_1_4.csv kalikho@172.16.117.17:/home/kalikho/icbc/verification_output/')
        print("===")
        print(datetime.datetime.now())
